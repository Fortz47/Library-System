...
class BooksRoutes extends BooksController {
  ...
  private routes(): void {
     ...
     *                       type: integer
     */
    this.router.route('/').post(this.InsertBook);
     ...
     */
    this.router.route('/:id').get(this.getBookWithId);
     ...
     *         description: Book not found
     */
    this.router.route('/:id').delete(this.deleteBook);
     ...
     *         description: Book not found
     */
    this.router.route('/:id').put(this.updateBook);
  }
}
